    ...
    >
      <div className="space-y-6 w-full">
        <Tabs defaultValue="business" className="w-full">
          <div className="sm:mb-0 lg:mb-6 md:mb-3 ">
            <TabsList className="grid grid-cols-2 gap-2 md:grid-cols-4 md:gap-0 w-full border-b pb-2 mb-4">
              <TabsTrigger className="py-3" value="business">
                Business Info
              </TabsTrigger>
              <TabsTrigger className="py-3" value="app">
                App Config
              </TabsTrigger>
              <TabsTrigger className="py-3" value="users">
                Admin Users
              </TabsTrigger>
              <TabsTrigger className="py-3" value="notifications">
                Notifications
              </TabsTrigger>
            </TabsList>
          </div>
                  ...
                  <div className="space-y-4 overflow-x-hidden">
                    {loading ? (
                      ...
                      admins.map((user) => (
                        <div
                          key={user.id}
                          className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-zinc-200 rounded-lg gap-4 min-w-0"
                        >
                          {/* Left section */}
                          ...
                          {/* Right section */}
                          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-6 flex-shrink-0 mt-0 sm:mt-0 min-w-0">
                            <div className="text-center min-w-max">
                              <Badge
                                variant="outline"
                                className="mb-1 sm:mb-2 block truncate max-w-[120px]"
                              >
                                {user.role
                                  .toLowerCase()
                                  .replace(/_/g, " ")
