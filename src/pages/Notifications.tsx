...
const Notifications = () => {
  ...
  const notificationHistory = [
    {
      ...
      message:
        "Celebrate the New Year with amazing discounts on all products...",
      audience: "All Users",
    ...
    },
    {
      ...
      message:
        "Check out our new collection of organic fruits and vegetables...",
    ...
    },
    {
      ...
      message:
        "Your order #ORD-001 has been confirmed and is being prepared...",
      audience: "John Doe",
  ...
  const templates = [
    ...
    },
    {
      ...
      message:
        "Your order is out for delivery and will arrive within 30 minutes.",
    },
    {
      id: 3,
      ...
      message:
        "Enjoy exclusive discounts on your favorite products. Limited time offer!",
    },
  ];
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label>Preview</Label>
                    <div className="mt-2 p-4 border rounded-lg bg-zinc-200">
              ...
              <CardContent>
                <div className="space-y-4">
                  {notificationHistory.map((notification) => (
                    <div
                      key={notification.id}
                      className="p-4 bg-zinc-200 rounded-lg"
                    >
